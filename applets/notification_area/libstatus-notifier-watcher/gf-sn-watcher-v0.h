...
#define GF_SN_WATCHER_V0(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GF_TYPE_SN_WATCHER_V0, GfSnWatcherV0))
#define GF_IS_SN_WATCHER_V0(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GF_TYPE_SN_WATCHER_V0))
