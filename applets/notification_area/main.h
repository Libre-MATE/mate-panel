...
#define NA_TRAY_APPLET(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), NA_TYPE_TRAY_APPLET, NaTrayApplet))
#define NA_TRAY_APPLET_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), NA_TYPE_TRAY_APPLET, NaTrayAppletClass))
#define NA_IS_TRAY_APPLET(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), NA_TYPE_TRAY_APPLET))
#define NA_IS_TRAY_APPLET_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), NA_TYPE_TRAY_APPLET))
#define NA_TRAY_APPLET_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), NA_TYPE_TRAY_APPLET, NaTrayAppletClass))
