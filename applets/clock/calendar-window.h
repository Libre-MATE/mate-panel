...
#define CALENDAR_WINDOW(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), CALENDAR_TYPE_WINDOW, CalendarWindow))
#define CALENDAR_WINDOW_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), CALENDAR_TYPE_WINDOW, CalendarWindowClass))
#define CALENDAR_IS_WINDOW(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), CALENDAR_TYPE_WINDOW))
#define CALENDAR_IS_WINDOW_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), CALENDAR_TYPE_WINDOW))
#define CALENDAR_WINDOW_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), CALENDAR_TYPE_WINDOW, CalendarWindowClass))
...
GtkWidget *calendar_window_new(time_t *static_current_time,
                               const char *prefs_dir, gboolean invert_order);
