...
#define CLOCK_MAP_CLASS(c) \
  (G_TYPE_CHECK_CLASS_CAST((c), CLOCK_MAP_TYPE, ClockMapClass))
...
#define CLOCK_MAP_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), CLOCK_MAP_TYPE, ClockMapClass))
