...
#define CLOCK_LOCATION(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), CLOCK_LOCATION_TYPE, ClockLocation))
#define CLOCK_LOCATION_CLASS(c) \
  (G_TYPE_CHECK_CLASS_CAST((c), CLOCK_LOCATION_TYPE, ClockLocationClass))
#define IS_CLOCK_LOCATION(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), CLOCK_LOCATION_TYPE))
#define IS_CLOCK_LOCATION_CLASS(c) \
  (G_TYPE_CHECK_CLASS_TYPE((c), CLOCK_LOCATION_TYPE))
#define CLOCK_LOCATION_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), CLOCK_LOCATION_TYPE, ClockLocationClass))
