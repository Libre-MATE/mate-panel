...
void panel_profile_remove_from_list(PanelGSettingsKeyType type, const char *id);
...
void panel_profile_set_toplevel_name(PanelToplevel *toplevel, const char *name);
...
void panel_profile_set_toplevel_size(PanelToplevel *toplevel, int size);
...
void panel_profile_set_background_fit(PanelToplevel *toplevel, gboolean fit);
