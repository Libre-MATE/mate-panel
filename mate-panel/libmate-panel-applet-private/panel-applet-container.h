...
#define MATE_PANEL_APPLET_CONTAINER(obj)                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), PANEL_TYPE_APPLET_CONTAINER, \
                              MatePanelAppletContainer))
#define MATE_PANEL_APPLET_CONTAINER_CLASS(klass)                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), PANEL_TYPE_APPLET_CONTAINER, \
                           MatePanelAppletContainerClass))
#define PANEL_IS_APPLET_CONTAINER(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), PANEL_TYPE_APPLET_CONTAINER))
#define PANEL_IS_APPLET_CONTAINER_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), PANEL_TYPE_APPLET_CONTAINER))
#define MATE_PANEL_APPLET_CONTAINER_GET_CLASS(obj)               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), PANEL_TYPE_APPLET_CONTAINER, \
                             MatePanelAppletContainerClass))

#define MATE_PANEL_APPLET_CONTAINER_ERROR \
...
struct _MatePanelAppletContainerClass {
  ...
  void (*applet_lock)(MatePanelAppletContainer *container, gboolean locked);
