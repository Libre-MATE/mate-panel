...
#define PANEL_MENU_BUTTON(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_MENU_BUTTON, PanelMenuButton))
#define PANEL_MENU_BUTTON_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_MENU_BUTTON, PanelMenuButtonClass))
#define PANEL_IS_MENU_BUTTON(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_MENU_BUTTON))
#define PANEL_IS_MENU_BUTTON_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_MENU_BUTTON))
#define PANEL_MENU_BUTTON_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_MENU_BUTTON, PanelMenuButtonClass))
