...
#define PANEL_TOPLEVEL(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_TOPLEVEL, PanelToplevel))
#define PANEL_TOPLEVEL_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_TOPLEVEL, PanelToplevelClass))
#define PANEL_IS_TOPLEVEL(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_TOPLEVEL))
#define PANEL_IS_TOPLEVEL_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_TOPLEVEL))
#define PANEL_TOPLEVEL_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_TOPLEVEL, PanelToplevelClass))
...
void panel_toplevel_set_auto_hide(PanelToplevel *toplevel, gboolean autohide);
...
void panel_toplevel_set_unhide_delay(PanelToplevel *toplevel, int unhide_delay);
