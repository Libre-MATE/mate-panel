...
#define PANEL_PLACE_MENU_ITEM(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_PLACE_MENU_ITEM, \
                              PanelPlaceMenuItem))
#define PANEL_PLACE_MENU_ITEM_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_PLACE_MENU_ITEM, \
                           PanelPlaceMenuItemClass))
#define PANEL_IS_PLACE_MENU_ITEM(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_PLACE_MENU_ITEM))
#define PANEL_IS_PLACE_MENU_ITEM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_PLACE_MENU_ITEM))
#define PANEL_PLACE_MENU_ITEM_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_PLACE_MENU_ITEM, \
                             PanelPlaceMenuItemClass))
...
#define PANEL_DESKTOP_MENU_ITEM(o)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_DESKTOP_MENU_ITEM, \
                              PanelDesktopMenuItem))
#define PANEL_DESKTOP_MENU_ITEM_CLASS(k)                      \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_DESKTOP_MENU_ITEM, \
                           PanelDesktopMenuItemClass))
#define PANEL_IS_DESKTOP_MENU_ITEM(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_DESKTOP_MENU_ITEM))
#define PANEL_IS_DESKTOP_MENU_ITEM_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_DESKTOP_MENU_ITEM))
#define PANEL_DESKTOP_MENU_ITEM_GET_CLASS(o)                    \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_DESKTOP_MENU_ITEM, \
                             PanelDesktopMenuItemClass))
