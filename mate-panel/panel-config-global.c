...
static void panel_global_config_set_entry(GSettings *settings, gchar *key) {
...
static void panel_global_config_notify(GSettings *settings, gchar *key,
                                       gpointer user_data) {
...
void panel_global_config_load(void) {
  ...
  g_signal_connect(panel_global_settings, "changed",
                   G_CALLBACK(panel_global_config_notify), NULL);
