...
#define PANEL_FRAME(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_FRAME, PanelFrame))
#define PANEL_FRAME_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_FRAME, PanelFrameClass))
...
#define PANEL_FRAME_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_FRAME, PanelFrameClass))
...
void panel_frame_set_edges(PanelFrame *toplevel, PanelFrameEdge edges);
