...
#define BUTTON_WIDGET(object) \
  (G_TYPE_CHECK_INSTANCE_CAST((object), BUTTON_TYPE_WIDGET, ButtonWidget))
#define BUTTON_WIDGET_CLASS(klass)	(G_TYPE_CHECK_CLASS_CAST ((klass, BUTTON_TYPE_WIDGET, ButtonWidgetClass))
#define BUTTON_IS_WIDGET(object) \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), BUTTON_TYPE_WIDGET))
#define BUTTON_IS_WIDGET_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), BUTTON_TYPE_WIDGET))
...
GtkWidget *button_widget_new(const char *pixmap, gboolean arrow,
