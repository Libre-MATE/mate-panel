...
#define PANEL_MENU_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_MENU_BAR, PanelMenuBar))
#define PANEL_MENU_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_MENU_BAR, PanelMenuBarClass))
#define PANEL_IS_MENU_BAR(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_MENU_BAR))
#define PANEL_IS_MENU_BAR_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_MENU_BAR))
#define PANEL_MENU_BAR_GET_CLASS(o) \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_MENU_BAR, PanelMenuBarClass))
