...
static const GOptionEntry options[] = {
    {"replace", 0, 0, G_OPTION_ARG_NONE, &replace,
     N_("Replace a currently running panel"), NULL},
    /* this feature was request in #mate irc channel */
    {"reset", 0, 0, G_OPTION_ARG_NONE, &reset,
     N_("Reset the panel configuration to default"), NULL},
    /* open run dialog */
    {"run-dialog", 0, 0, G_OPTION_ARG_NONE, &run_dialog,
     N_("Execute the run dialog"), NULL},
    /* default panels layout */
    {"layout", 0, 0, G_OPTION_ARG_STRING, &layout,
     N_("Set the default panel layout"), NULL},
    {NULL, 0, 0, G_OPTION_ARG_NONE, NULL, NULL, NULL}};

static void parsing_error_cb(GtkCssProvider *provider, GtkCssSection *section,
...
int main(int argc, char **argv) {
...
#ifdef HAVE_X11
  if (GDK_IS_X11_DISPLAY(display)) panel_action_protocol_init();
#endif
  ...
  g_signal_connect(provider, "parsing-error", G_CALLBACK(parsing_error_cb),
                   NULL);
