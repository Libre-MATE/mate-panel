...
struct _PanelWidgetClass {
  ...
  void (*applet_move)(PanelWidget *panel, GtkWidget *applet);
  void (*applet_added)(PanelWidget *panel, GtkWidget *applet);
  void (*applet_removed)(PanelWidget *panel, GtkWidget *applet);
  void (*push_move)(PanelWidget *panel, GtkDirectionType dir);
  void (*switch_move)(PanelWidget *panel, GtkDirectionType dir);
  void (*free_move)(PanelWidget *panel, GtkDirectionType dir);
  void (*tab_move)(PanelWidget *panel, gboolean next);
...
int panel_widget_reparent(PanelWidget *old_panel, PanelWidget *new_panel,
...
void panel_widget_draw_all(PanelWidget *panel, GdkRectangle *area);
/*draw just one icon (applet has to be an icon of course)*/
void panel_widget_draw_icon(PanelWidget *panel, ButtonWidget *applet);
...
PanelObjectEdgeRelativity panel_widget_determine_applet_edge_relativity(
    PanelWidget *panel, GtkWidget *applet);
