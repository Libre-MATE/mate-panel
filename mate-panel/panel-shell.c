...
static void panel_shell_on_name_lost(GDBusConnection *connection,
...
static void panel_shell_cleanup(gpointer data) {
...
gboolean panel_shell_register(gboolean replace) {
  ...
  if (dbus_connection != NULL) return TRUE;
  ...
  result = g_dbus_connection_call_sync(
      dbus_connection, "org.freedesktop.DBus", "/org/freedesktop/DBus",
      "org.freedesktop.DBus", "RequestName",
      g_variant_new("(su)", PANEL_DBUS_SERVICE, flags), G_VARIANT_TYPE("(u)"),
  ...
  switch (request_name_reply) {
    ...
    case 4: /* DBUS_REQUEST_NAME_REPLY_ALREADY_OWNER */
      ...
      g_dbus_connection_signal_subscribe(
          dbus_connection, "org.freedesktop.DBus", "org.freedesktop.DBus",
          "NameLost", "/org/freedesktop/DBus", PANEL_DBUS_SERVICE,
          G_DBUS_SIGNAL_FLAGS_NONE,
          (GDBusSignalCallback)panel_shell_on_name_lost, NULL, NULL);
      break;
    case 2: /* DBUS_REQUEST_NAME_REPLY_IN_QUEUE */
    case 3: /* DBUS_REQUEST_NAME_REPLY_EXISTS */
      g_printerr(
          "Cannot register the panel shell: there is "
          "already one running.\n");
      break;
    default:
      g_warning(
          "Cannot register the panel shell: unhandled "
          "reply %u from RequestName",
          request_name_reply);
  }
...
void panel_shell_quit(void) {
  ...
  for (l = toplevels_to_destroy; l; l = l->next) gtk_widget_destroy(l->data);
