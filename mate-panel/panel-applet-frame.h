...
#define MATE_PANEL_APPLET_FRAME(o)                          \
  (G_TYPE_CHECK_INSTANCE_CAST((o), PANEL_TYPE_APPLET_FRAME, \
                              MatePanelAppletFrame))
#define MATE_PANEL_APPLET_FRAME_CLASS(k)                 \
  (G_TYPE_CHECK_CLASS_CAST((k), PANEL_TYPE_APPLET_FRAME, \
                           MatePanelAppletFrameClass))
#define PANEL_IS_APPLET_FRAME(o) \
  (G_TYPE_CHECK_INSTANCE_TYPE((o), PANEL_TYPE_APPLET_FRAME))
#define PANEL_IS_APPLET_FRAME_CLASS(k) \
  (G_TYPE_CHECK_CLASS_TYPE((k), PANEL_TYPE_APPLET_FRAME))
#define MATE_PANEL_APPLET_FRAME_GET_CLASS(o)               \
  (G_TYPE_INSTANCE_GET_CLASS((o), PANEL_TYPE_APPLET_FRAME, \
                             MatePanelAppletFrameClass))
...
struct _MatePanelAppletFrameClass {
  ...
  void (*sync_menu_state)(MatePanelAppletFrame *frame, gboolean movable,
                          gboolean removable, gboolean lockable,
                          gboolean locked, gboolean locked_down);

  void (*popup_menu)(MatePanelAppletFrame *frame, guint button,
                     guint32 timestamp);

  void (*change_orientation)(MatePanelAppletFrame *frame,
                             PanelOrientation orientation);

  void (*change_size)(MatePanelAppletFrame *frame, guint size);
